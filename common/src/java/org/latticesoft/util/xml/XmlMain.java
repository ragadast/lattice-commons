...
/*
 * If wanna convert into a reference also can be resolved its like
 * xml property map, but must take care of cyclic reference. 
 * 
 */
...
public class XmlMain implements Serializable {
	...
	public XmlMain() {
		XmlHelper.main = this;
		if (log.isDebugEnabled()) { log.debug("Setting the main into the class variable"); }
	}
