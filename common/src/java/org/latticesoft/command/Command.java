...
public interface Command {
	...
	/**
	 * Executes a unit of processing (within a {@link Chain}). The scope of
	 * the execution depends on the design of the system.
	 *
	 ...
	 */
	Object execute(Object o) throws CommandException;
}