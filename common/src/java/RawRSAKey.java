 ...
 * consist of the modulus and exponent values. This class does not differ
 * between a public and private RSA key. The main functionality of this class is
 * to store the necessary components for re-creating an RSAPublicKey or
 * RSAPrivateKey. The components may be stored and retrieved from another
 * location.
 */
public class RawRSAKey {
	/**
	 * This field represents the empty argument for the parts that make up
	 * the key. This value will be returned if the key parts (modulus and
	 * exponent) are not initialized.
	 */
	...
	/**
	 * Creates a RawRSAKey object to represent an RSA key value.
	 */
	private RawRSAKey () {
	}
	 ...
	 */
	private RawRSAKey(BigInteger pModulus, BigInteger pExponent) {
		mModulus = pModulus;
		mExponent = pExponent;
	}
	...
	/**
	 * Returns the modulus portion of the RSA key represented by this
	 * object.
	 * 
	 * @return BigInteger representing the modulus, or the empty argument if
	 *         not initialized.
	 * @see #emptyBigInt
	 */
	...
	/**
	 * Returns the exponent portion of the RSA key represented by this
	 * object.
	 * @return BigInteger representing the modulus, or the empty argument if not initialized.
	 * @see #emptyBigInt
	 */
	...
	public static void main(String[] args) {
		try {
			RawRSAKey key = RawRSAKey.getInstance("src/temp/public_asn1_key");
		} catch (Exception e) {
			e.printStackTrace();
		}
